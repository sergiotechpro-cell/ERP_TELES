...
<div class="container-fluid">
  <div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-2">
    ...
    <div class="d-flex gap-2">
      ...
      <a href="{{ route('inventario.warehouses.create') }}" class="btn btn-primary">
              ...
              <tr>
                ...
                <td class="text-end">
                  <div class="btn-group" role="group">
                    <a href="{{ route('inventario.warehouses.edit', $bodega) }}" 
                       class="btn btn-sm btn-outline-primary" 
                       title="Editar">
                      <i class="bi bi-pencil"></i>
                    </a>
                    <form action="{{ route('inventario.warehouses.destroy', $bodega) }}" 
                          method="POST" 
                          class="d-inline"
